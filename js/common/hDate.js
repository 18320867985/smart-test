var calendar = {
    ...
    init: function (s) {
        ...
        _c.push("<div id='calendar_head' class='calendar_head'><em class='calendaremL'>«</em><input id='_calyear' readonly='true' type='text' value='" + currYea + "' /><input id='_calmod' type='text' readonly='true' value='" + currMon + "' /><em class='calendaremR'>»</em>");
        _c.push(_yers.join(""));
